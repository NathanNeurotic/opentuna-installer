...
all:
	$(MAKE) $(EE_BIN_PACKED)
powerpoweroff_elf.s:
	bin2s INSTALL/SYS_POWEROFF/POWEROFF.ELF powerpoweroff_elf.s powerpoweroff_elf

powericon_sys.s:
	bin2s INSTALL/SYS_POWEROFF/icon.sys powericon_sys.s powericon_sys

powerlist_icn.s:
	bin2s INSTALL/SYS_POWEROFF/list.icn powerlist_icn.s powerlist_icn

powertitle_cfg.s:
	bin2s INSTALL/SYS_POWEROFF/title.cfg powertitle_cfg.s powertitle_cfg
